...
| **TC-INV-02** | Invoice | Membuat Invoice dengan input nominal huruf | Berada di form buat Invoice | 1. Masukkan huruf pada kolom Harga.<br>2. Klik Buat Invoice | Sistem menolak dengan pesan error format nominal |
| **TC-INV-03** | Invoice | Membuat Invoice dengan diskon 0% dan 100% | Berada di form buat Invoice | 1. Masukkan diskon 0% lalu simpan.<br>2. Masukkan diskon 100% lalu simpan | Sistem dapat mengkalkulasi akhir dengan benar tanpa minus |
